            ...
            <div class="col-lg-12">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.update.category', $category->id) }}" method="POST" id="updateCategory"> 
                            @csrf
                            @method('PUT')
                            {{-- @dd($category); --}}
                            <div class="row g-3">
                                ...
                                <div class="col-xxl-6">
                                    <div>
                                        ...
                                        <select class="form-select mb-3" aria-label="status" name="status">
                                            <option value="1" @selected(old('status',  $category->status) == 1 ? 'selected' :'' )>Active</option>
                                            {{-- <option value="1">Active</option> --}}
                                            <option value="0" @selected(old('status',  $category->status) == 0 ? 'selected' :'' )>Inactive</option>
