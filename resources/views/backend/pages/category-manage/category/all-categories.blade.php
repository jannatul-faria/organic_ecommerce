                ...
                <div class="card">
                    <div class="card-header p-4 d-flex justify-content-between align-items-center">
                        ...
                        <div class="add-category ">
                            <!-- Grids in modals -->
                            <a href="{{ route('admin.add.category') }}" class="btn btn-primary waves-effect waves-light">
                                Add new category
                            </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hstack gap-3 flex-wrap">
                                            <a href="{{ route('admin.edit.category', $value->id) }}" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
