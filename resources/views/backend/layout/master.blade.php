...
>
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/backend') }}/images/logo_icon.png" />

    <!-- jsvectormap css -->
    <link
      href="{{ asset('assets/backend') }}/libs/jsvectormap/css/jsvectormap.min.css"
      rel="stylesheet"
      type="text/css"
    />
    ...
    <!--Swiper slider css-->
    <link
      href="{{ asset('assets/backend') }}/libs/swiper/swiper-bundle.min.css"
      rel="stylesheet"
      type="text/css"
    />
