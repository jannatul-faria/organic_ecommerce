        ...
        <div class="d-flex">
          ...
          <div class="navbar-brand-box horizontal-logo">
            <a href="index.html" class="logo logo-dark">
              <span class="logo-sm">
                <img src="{{ asset('assets/backend') }}/images/icon_logo.png" alt="" height="22" />
              </span>
              <span class="logo-lg">
                <img src="{{ asset('assets/backend') }}/images/logo.png" alt="" height="17" />
              </span>
            </a>
                        ...
                        <div class="simplebar-content" style="padding: 0px">
                          ...
                          <div class="notification-list">
                            ...
                            >
                              <div class="d-flex">
                                <img
                                  src="{{ asset('assets/backend') }}/images/users/avatar-5.jpg"
                                  class="me-3 rounded-circle avatar-xs"
                                  alt="user-pic"
                                />
                                <div class="flex-1">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown ms-1 topbar-head-dropdown header-item">
            ...
            >
              <img
                id="header-lang-img"
                src="{{ asset('assets/backend') }}/images/flags/us.svg"
                alt="Header Language"
                height="20"
                class="rounded"
              />
            ...
            <div class="dropdown-menu dropdown-menu-end">
              ...
              >
                <img
                  src="{{ asset('assets/backend') }}/images/flags/spain.svg"
                  alt="user-image"
                  class="me-2 rounded"
                  height="18"
                />
              ...
              >
                <img
                  src="{{ asset('assets/backend') }}/images/flags/germany.svg"
                  alt="user-image"
                  class="me-2 rounded"
                  height="18"
                />
              ...
              >
                <img
                  src="{{ asset('assets/backend') }}/images/flags/italy.svg"
                  alt="user-image"
                  class="me-2 rounded"
                  height="18"
                />
              ...
              >
                <img
                  src="{{ asset('assets/backend') }}/images/flags/russia.svg"
                  alt="user-image"
                  class="me-2 rounded"
                  height="18"
                />
              ...
              >
                <img
                  src="{{ asset('assets/backend') }}/images/flags/china.svg"
                  alt="user-image"
                  class="me-2 rounded"
                  height="18"
                />
              ...
              >
                <img
                  src="{{ asset('assets/backend') }}/images/flags/french.svg"
                  alt="user-image"
                  class="me-2 rounded"
                  height="18"
                />
              ...
              <div class="p-2">
                <div class="row g-0">
                  <div class="col">
                    <a class="dropdown-icon-item" href="#!">
                      <img
                        src="{{ asset('assets/backend') }}/images/brands/github.png"
                        alt="Github"
                      />
                      <span>GitHub</span>
                    </a>
                  ...
                  <div class="col">
                    <a class="dropdown-icon-item" href="#!">
                      <img
                        src="{{ asset('assets/backend') }}/images/brands/bitbucket.png"
                        alt="bitbucket"
                      />
                      <span>Bitbucket</span>
                    </a>
                  ...
                  <div class="col">
                    <a class="dropdown-icon-item" href="#!">
                      <img
                        src="{{ asset('assets/backend') }}/images/brands/dribbble.png"
                        alt="dribbble"
                      />
                      <span>Dribbble</span>
                    </a>
                ...
                <div class="row g-0">
                  <div class="col">
                    <a class="dropdown-icon-item" href="#!">
                      <img
                        src="{{ asset('assets/backend') }}/images/brands/dropbox.png"
                        alt="dropbox"
                      />
                      <span>Dropbox</span>
                    </a>
                  ...
                  <div class="col">
                    <a class="dropdown-icon-item" href="#!">
                      <img
                        src="{{ asset('assets/backend') }}/images/brands/mail_chimp.png"
                        alt="mail_chimp"
                      />
                  ...
                  <div class="col">
                    <a class="dropdown-icon-item" href="#!">
                      <img
                        src="{{ asset('assets/backend') }}/images/brands/slack.png"
                        alt="slack"
                      />
                      <span>Slack</span>
                    </a>
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-auto">
                    <span class="badge badge-soft-warning fs-13"
                      ><span class="cartitem-badge">5</span> items</span
                    >
                  </div>
                </div>
              </div>
                        ...
                        <div class="simplebar-content" style="padding: 0px">
                          <div class="p-2">
                            ...
                            >
                              <div class="d-flex align-items-center">
                                <img
                                  src="{{ asset('assets/backend') }}/images/products/img-6.png"
                                  class="me-3 rounded-circle avatar-sm p-2 bg-light"
                                  alt="user-pic"
                                />
                                <div class="flex-1">
              ...
              <div class="tab-content" id="notificationItemsTabContent">
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <div class="d-flex">
                                  <img
                                    src="{{ asset('assets/backend') }}/images/users/avatar-8.jpg"
                                    class="me-3 rounded-circle avatar-xs"
                                    alt="user-pic"
                                  />
                                  <div class="flex-1">
                ...
                >
                  <div class="w-25 w-sm-50 pt-3 mx-auto">
                    <img
                      src="{{ asset('assets/backend') }}/images/svg/bell.svg"
                      class="img-fluid"
                      alt="user-pic"
                    />
                  </div>
