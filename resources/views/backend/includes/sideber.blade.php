 ...
 <div class="app-menu navbar-menu">
     ...
     <div class="navbar-brand-box">
         ...
         <a href="index.html" class="logo logo-dark">
             ...
             <span class="logo-lg">
                 <img src="{{ asset('assets/backend') }}/images/icon_logo.png" alt="" height="22" /><img
                     src="{{ asset('assets/backend') }}/images/logo.png" alt="" height="20" />
             </span>
         </a>
         <!-- Light Logo-->
                                                                 ...
                                                                 <ul class="nav nav-sm flex-column">
                                                                     ...
                                                                     <li class="nav-item">
                                                                         <a href="dashboard-crypto.html"
                                                                             class="nav-link" data-key="t-crypto">
                                                                             Crypto
                                                                         </a>
                                                                     </li>
                                                                     <li class="nav-item">
...
{{-- 
                                                                 ...
                                                                 <ul class="nav nav-sm flex-column">
                                                                     ...
                                                                     <li class="nav-item">
                                                                         ...
                                                                         <div class="collapse menu-dropdown"
                                                                             ...
                                                                             <ul class="nav nav-sm flex-column">
                                                                                 <li class="nav-item">
                                                                                     <a href="auth-pass-change-basic.html"
                                                                                         class="nav-link"
                                                                                         data-key="t-basic">
                                                                                         Basic
                                                                                     </a>
                                                                                 ...
                                                                                 <li class="nav-item">
                                                                                     <a href="auth-pass-change-cover.html"
                                                                                         class="nav-link"
                                                                                         data-key="t-cover">
                                                                                         Cover
                                                                                     </a>
                                                                     ...
                                                                     <li class="nav-item">
                                                                         ...
                                                                         <div class="collapse menu-dropdown"
                                                                             ...
                                                                             <ul class="nav nav-sm flex-column">
                                                                                 <li class="nav-item">
                                                                                     <a href="auth-lockscreen-basic.html"
                                                                                         class="nav-link"
                                                                                         data-key="t-basic">
                                                                                         Basic
                                                                                     </a>
                                                                                 ...
                                                                                 <li class="nav-item">
                                                                                     <a href="auth-lockscreen-cover.html"
                                                                                         class="nav-link"
                                                                                         data-key="t-cover">
                                                                                         Cover
                                                                                     </a>
                                                                     ...
                                                                     <li class="nav-item">
                                                                         ...
                                                                         <div class="collapse menu-dropdown"
                                                                             ...
                                                                             <ul class="nav nav-sm flex-column">
                                                                                 <li class="nav-item">
                                                                                     <a href="auth-success-msg-basic.html"
                                                                                         class="nav-link"
                                                                                         data-key="t-basic">
                                                                                         Basic
                                                                                     </a>
                                                                                 ...
                                                                                 <li class="nav-item">
                                                                                     <a href="auth-success-msg-cover.html"
                                                                                         class="nav-link"
                                                                                         data-key="t-cover">
                                                                                         Cover
                                                                                     </a>
                                                                     ...
                                                                     <li class="nav-item">
                                                                         ...
                                                                         <div class="collapse menu-dropdown"
                                                                             ...
                                                                             <ul class="nav nav-sm flex-column">
                                                                                 <li class="nav-item">
                                                                                     <a href="auth-twostep-basic.html"
                                                                                         class="nav-link"
                                                                                         data-key="t-basic">
                                                                                         Basic
                                                                                     </a>
                                                                                 ...
                                                                                 <li class="nav-item">
                                                                                     <a href="auth-twostep-cover.html"
                                                                                         class="nav-link"
                                                                                         data-key="t-cover">
                                                                                         Cover
                                                                                     </a>
                                                                 ...
                                                                 <ul class="nav nav-sm flex-column">
                                                                     ...
                                                                     <li class="nav-item">
                                                                         <a href="pages-timeline.html"
                                                                             class="nav-link" data-key="t-timeline">
                                                                             Timeline
                                                                         </a>
                                                                     </li>
                                                                     <li class="nav-item">
                                                                         <a href="pages-faqs.html" class="nav-link"
                                                                             data-key="t-faqs">
                                                                             FAQs
                                                                         </a>
                                                                     </li>
                                                                     ...
                                                                     <li class="nav-item">
                                                                         <a href="pages-sitemap.html" class="nav-link"
                                                                             data-key="t-sitemap">
                                                                             Sitemap
                                                                         </a>
                                                                     </li>
                                                         ...
                                                         <li class="nav-item">
                                                             ...
                                                             <div class="collapse menu-dropdown"
                                                                 ...
                                                                 <ul class="nav nav-sm flex-column">
                                                                     <li class="nav-item">
                                                                         <a href="advance-ui-sweetalerts.html"
                                                                             class="nav-link"
                                                         ...
                                                         <li class="nav-item">
                                                             ...
                                                             <div class="collapse menu-dropdown" id="sidebarForms">
                                                                 <ul class="nav nav-sm flex-column">
                                                                     ...
                                                                     <li class="nav-item">
                                                                         <a href="forms-checkboxs-radios.html"
                                                                             class="nav-link"
                                                                 ...
                                                                 <ul class="nav nav-sm flex-column">
                                                                     <li class="nav-item">
                                                                         ...
                                                                         <div class="collapse menu-dropdown"
                                                                             ...
                                                                             <ul class="nav nav-sm flex-column">
                                                                                 ...
                                                                                 <li class="nav-item">
                                                                                     <a href="charts-apex-boxplot.html"
                                                                                         class="nav-link"
                                                                                         data-key="t-boxplot">
                                                                                         Boxplot
                                                                                     </a>
                                                                     ...
                                                                     <li class="nav-item">
                                                                         <a href="charts-chartjs.html"
                                                                             class="nav-link" data-key="t-chartjs">
                                                                             Chartjs
                                                                         </a>
                                                                     </li>
                                                                     <li class="nav-item">
                                                                         <a href="charts-echarts.html"
                                                                             class="nav-link" data-key="t-echarts">
                                                                             Echarts
                                                                         </a>
                                                                     </li>
                                                                 </ul>
                                                                 ...
                                                                 <ul class="nav nav-sm flex-column">
                                                                     ...
                                                                     <li class="nav-item">
                                                                         <a href="maps-leaflet.html"
                                                                             class="nav-link" data-key="t-leaflet">
                                                                             Leaflet
                                                                         </a>
                                                                     </li>
                                                                 </ul>
                                         ...
                                         <div class="simplebar-placeholder" style="width: 249px; height: 1058px">
                                         </div>
                                     </div>
             ...
             <div class="simplebar-placeholder" style="width: auto; height: 1058px"></div>
         </div>
         {{-- <div class="simplebar-track simplebar-horizontal" style="visibility: hidden">
             <div class="simplebar-scrollbar" style="width: 0px; display: none"></div>
         </div>
